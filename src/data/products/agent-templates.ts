...
export const agentTemplateTools: Record<string, ProductToolId[]> = {
  ...
  "NexEco AI helper": ["confluence", "google", "ms-sharepoint"],
...
export const agentTemplates: AgentTemplate[] = [
  ...
  },
  {
    ...
    description: "Helps you turn ideas into fully configured NexEco AI agents ready to run.",
  },
  {
    id: "prod-7",
    category: "Productivity",
    title: "NexEco AI helper",
    description: "Answers your questions about NexEco AI using official documentation.",
  },
  {
    id: "prod-8",
    category: "Productivity",
