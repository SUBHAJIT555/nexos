...
export function HostingerCircleOneIcon({ className }: IconProps) {
  return (
    <svg
...
export function HostingerCircleTwoIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="-64 -64 640 640"
...
export function HostingerCircleThreeIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="-64 -64 640 640"
...
export function HostingerCircleFourIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="-64 -64 640 640"
...
export const hostingerChallengeIcons = {
  one: HostingerCircleOneIcon,
  two: HostingerCircleTwoIcon,
  three: HostingerCircleThreeIcon,
  four: HostingerCircleFourIcon,
} as const;
