...
export function InfoDialog({ open, onClose, heading, paragraphs }: InfoDialogProps) {
  const titleId = useId();
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="mt-5 max-h-[min(70vh,520px)] space-y-4 overflow-y-auto text-base leading-6 text-neutral-700">
