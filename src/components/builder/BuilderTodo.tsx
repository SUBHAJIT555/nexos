...
import { builderTodo } from "@/data/products/builder";
  ...
  return (
    <section className="relative overflow-hidden bg-white py-16">
      <picture className="pointer-events-none absolute inset-0 md:hidden">
        <img
          src={assetSrc(builderIllustrations.promptGridBgXs)}
          alt=""
      ...
      <Container className="relative">
        <div className="mx-auto max-w-[768px] text-center">
          ...
          <p className="mt-5 text-base leading-6 text-neutral-700">
            {builderTodo.bodyBefore}
            <Link href={builderTodo.bodyLink.href} className="text-accent hover:text-[var(--accent-hover)]">
              {builderTodo.bodyLink.label}
            </Link>
            {builderTodo.bodyAfter}
          </p>
        </div>
        ...
        <div className="relative mt-10 overflow-hidden rounded-[16px]">
          ...
          <picture className="pointer-events-none absolute inset-0 hidden md:block">
            <img
              src={assetSrc(builderIllustrations.promptGridBg)}
              alt=""
              className="h-full w-full object-cover object-center"
            />
          </picture>
            ...
            <div className="w-full max-w-[784px]">
              <div className="flex flex-col gap-6 rounded-[20px] border-2 border-accent bg-white px-5 py-5 shadow-[0_8px_32px_rgb(107_62_255_/_0.08)]">
                <textarea
                  ...
                  placeholder={builderTodo.placeholder}
